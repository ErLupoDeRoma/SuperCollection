        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="relative overflow-hidden rounded-lg shadow-lg">
            ...
            <div className="absolute bottom-8 left-8 text-white">
              <h1 className="text-2xl font-bold">INSIEME IN OGNI AVVENTURA</h1>
            </div>
          </div>
          ...
          <div className="relative overflow-hidden rounded-lg shadow-lg ">
            ...
            />
            <div className="absolute bottom-8 left-8 text-white">
              <h1 className="text-2xl font-bold">PARTNER TECNICI</h1>
            </div>
          </div>
          ...
          <div className="relative overflow-hidden rounded-lg shadow-lg">
            ...
            />
            <div className="absolute bottom-8 left-8 text-white">
              <h1 className="text-2xl font-bold">NOLEGGIA LA TUA YAMAHA</h1>
            </div>
          </div>
        </div>
      </div>
