      ...
      <div className="absolute inset-0 flex items-center -mt-10">
        <div className="max-w-3xl px-8 md:px-16 lg:px-24">
          ...
          <h1 className="text-white text-md mb-10 font-semibold mt-2">
            Che tu voglia CORRERE più velocemente, SENTIRE la passione della
            guida o trovare la soluzione migliore per MUOVERSIin modo più
            intelligente, i nostri prodotti e servizi sono gli unici che possono
            offrirti l' esperienza Kando.
          </h1>
          <button
            href="#"
            className="-mt-5 bg-white hover:bg-red-500 hover:text-white border border-black text-black font-semibold text-sm px-7 py-3 rounded-full flex items-center gap-3 transition-all duration-300"
          >
            SCOPRI YAMAHA
          </button>
        </div>
